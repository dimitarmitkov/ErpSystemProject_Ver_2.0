...
{
    public class SalesTestsListOfAllSales
    {
        [Fact]
        public void CheckCorrectListOfAllSales()
        {
            var optionsBuilder = new DbContextOptionsBuilder<ErpSystemDbContext>().UseInMemoryDatabase("testListOfAllSales");
            ...
            var result = sale.ListOfAllSales().ToList();
