...
namespace ErpSystem.Data.Migrations
{
    ...
    [Migration("20201101100701_DbChangesWareghousePalletAndBox")]
    partial class DbChangesWareghousePalletAndBox
    {
            ...
            modelBuilder.Entity("ErpSystem.Models.Warehouse", b =>
                {
                    ...
                    b.Property<int?>("BoxesDepthSpace")
                        .HasColumnType("int");

                    b.Property<int?>("BoxesFrontSpace")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ItemQuantityAvailable")
                        .HasColumnType("int");

                    b.Property<int>("PalletsSpace")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErpSystem.Models.Product", b =>
                {
                    ...
                    b.HasOne("ErpSystem.Models.Warehouse", null)
                        .WithMany("Products")
